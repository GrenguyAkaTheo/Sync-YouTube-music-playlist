...
Deleting songs doesn't really work properly right now, and you kinda need to remove the ID's and file from your drive. I am working to fix this though, so if you do want a working version, some back in a week or so and it'll probably be fixed
