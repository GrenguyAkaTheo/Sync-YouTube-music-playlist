...
The album tag is what youtube gives the script to use. If the album gets set to something like the song name this is because of youtube, not the script its self. If youtube doesn't provide an album tag, it will get tagged as the name of your storage drive (I think, because thats what Audatious is teling me) :D
