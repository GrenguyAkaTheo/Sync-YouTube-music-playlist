...
The album tag is what youtube gives the script to use. If the album gets set to something like the song name this is because of youtube (Or nothing at all), not the script its self :D
